...
public class JCalc
{
     ...
     * {@link ConfigurationBuilder} instance. If the expression is empty, {@code null} will be
     * returned. If the expression contains any whitespace, they'll be ignored. The
     * {@link ConfigurationBuilder} instance is used to customize the way the Math expressions are
